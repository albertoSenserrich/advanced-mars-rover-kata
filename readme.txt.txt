...
implement, this is something that we will leave up to you. For this reason here are a
...
■ Inputs, output, etc.
■ You can even decide to store extra information calculated from
the outcome of the execution (e.g. lost robots, explored surface,
etc.)
